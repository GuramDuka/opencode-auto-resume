...
- **Interrupted continue retries**: Tests for `interruptedContinueCount` cap at 3 retries. After the cap is reached, the counter resets to 0 and no further interrupted continue retries are attempted.
